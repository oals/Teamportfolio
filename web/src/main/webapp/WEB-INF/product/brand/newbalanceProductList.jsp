                ...
                <nav aria-label="...">
                    ...
                    <ul class="pagination">
                       	<c:forEach var="page" begin="1" end="${lastPage}" step="1" >
		                     ...
		                     <div id="prevbtn"></div>
	                       	 <c:if test="${section > 1 && page==1 }">
		                       	<li class="page-item ">
		                        	<a class="page-link" id="prev" name="prev" onclick="product_paging(${section-1},${page},'뉴발란스')">이전</a>
		                     ...
		                     <c:choose>
			                      ...
			                      <a class="page-link" id="${page}" onclick="product_paging(${section},${page},'뉴발란스')">${(section-1)*10 + page}</a>
                        ...
                        <!--  다음 버튼 : 현재 section번호가 전체 section 번호 보다 작은 경우만 표시-->
	                      ...
	                      <li class="page-item">
	                        <a class="page-link"  id="next" name="next"  onclick="product_paging(${section+1},${pageNum},'뉴발란스')">다음</a>
