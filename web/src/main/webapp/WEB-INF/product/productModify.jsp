...
<body id="page-top">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">상품 수정</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                        <div class="main mt-5">
	...
	<script type="text/javascript">
		...
		function admin_productUpdate(){
			location.href="${ctxPath}/admin_productUpdate.do"
		}
