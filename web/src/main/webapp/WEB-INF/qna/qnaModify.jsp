...
<body>
<div>qnaModify.jsp</div>
		<jsp:include page="../includes/headerNav.jsp" />

    <div class="main">
      <div class="container">
        <form action="${ctxPath}/qnaUpdate.do" method="get" class="mb-5">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                ...
                >
                  ...
                  <option value="1" selected>문의사항</option>
                </select>
              </div>
            </div>
            <div class="mb-3 row">
...
${board.qna_content}</textarea
    ...
    <input type="hidden" id="qna_num" name="qna_num" value="${board.qna_num}">
      ...
      <jsp:include page="../includes/footer.jsp" />
        ...
        <script type="text/javascript">
	        ...
	        function qnaUpdate(){
        		location.href="${ctxPath}/qnaUpdate.do"
        	}
        	function qnaList(){
